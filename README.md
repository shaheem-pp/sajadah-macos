...
- Adhan times adjustable by the minute, per prayer, under Settings → Advanced — for a community whose calendar runs a few minutes off the method it follows. Off by default; applies everywhere, without a refetch
